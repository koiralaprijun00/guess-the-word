...
export const EnhancedWordDisplayCard: React.FC<WordDisplayCardProps> = ({
  ...
  return (
    <div className="relative w-full perspective-1000" style={{ perspective: '1000px' }}>
      <div 
        className={cn(
      ...
      >
        ...
        <Card className={cn(
          ...
          urgencyLevel === 'urgent' && "animate-pulse shadow-red-500/50"
        )}>
          <CardContent className="bg-card p-8 rounded-md h-full flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 text-center space-y-6">
              <div className={cn(
                ...
                urgencyLevel === 'urgent' && "text-red-600 animate-bounce"
              )}>
                {word.nepali}
              </div>
                ...
                <div className="space-y-4">
                  <div className="relative">
                    ...
                    <div className={cn(
                      ...
                      urgencyLevel === 'urgent' && "bg-red-500/20 animate-ping"
                    )}></div>
                  </div>
